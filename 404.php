...
<?php echo the_permalink(); ?>
					<!-- <?php
						...
						if ( artseenin2016_categorized_blog() ) :
					?>

					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'artseenin2016' ); ?></h2>
						<ul>
						<?php
					...
					<?php
						...
						// $archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'artseenin2016' ), convert_smilies( ':)' ) ) . '</p>';
